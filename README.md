...
```
Releases are built by GitHub Actions on a version tag (`git tag v2.0.5 && git push origin v2.0.5`) — the `.dmg` and `.exe` are attached to the GitHub Release automatically.
